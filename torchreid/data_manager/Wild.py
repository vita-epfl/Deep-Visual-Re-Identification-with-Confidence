...
class Wild(BaseImageDataset):
    ...
    def __init__(self, root='/data/linah-data/', verbose=True, **kwargs):
        ...
        self.query_path = osp.join(self.dataset_dir, 'train_test_split/test_3000_query.txt')
        self.gallery_path = osp.join(self.dataset_dir, 'train_test_split/test_3000.txt')
